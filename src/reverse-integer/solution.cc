// From https://github.com/haoel/leetcode/blob/master/src/reverseInteger/reverseInteger.cpp
#include <stdio.h>
#include <stdlib.h>
...
int reverse(int x) {
    ...
    int n;
    while( x != 0){
        // C++ returns negative value when x is negative, not like Python.
        // which makes checking negative value unnecessary.
        n = x%10;
